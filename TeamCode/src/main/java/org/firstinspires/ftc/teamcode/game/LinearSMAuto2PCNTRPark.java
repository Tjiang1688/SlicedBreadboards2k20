 ...
 */
//@Autonomous(name="LinearSMAuto2PCNTRPark", group="auto")  // @Autonomous(...) is the other common choice
@Disabled
public class LinearSMAuto2PCNTRPark extends LinearVisionOpMode {
    /***
     * VISION VARIABLES
     */
    ...
    public void stateMachine(STATE currentState) throws InterruptedException {
        switch (currentState) {
            ...
            case BEGIN: {
                ...
                robot.drive.queuePath(new PathSeg(14 * 0.95, -14 * 0.95, runtime));
                ...
                robot.drive.queuePath(new PathSeg(12 * 5.7, 12 * 5.7, runtime));
                robot.drive.startPath();
